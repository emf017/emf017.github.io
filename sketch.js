...
function preload() {
  ...
  puppyBark = loadSound("pupBark.mp3");  // preload the sound file
}
...
//  createCanvas(windowWidth, windowHeight);
  ...
  puppyBark.loop();  // play the sound file repeatedly
...
class Ball { // Constructor
  ...
  display() {
    ...
    rect(this.ballX, this.ballY, this.size);
  }
